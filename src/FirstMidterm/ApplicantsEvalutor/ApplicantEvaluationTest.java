package FirstMidterm.ApplicantsEvalutor;
...
class EvaluatorBuilder {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluation {
        ...
        switch (type){
            ...
            case NO_CRIMINAL_RECORD: return (applicant -> !applicant.hasCriminalRecord());
            case MORE_EXPERIENCE: return (applicant -> applicant.getEmploymentYears() >= 10);
            case MORE_CREDIT_SCORE: return (applicant -> applicant.getCreditScore() >= 500);
            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE: return (applicant -> !applicant.hasCriminalRecord() && applicant.getEmploymentYears() >=10);
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE: return (applicant -> !applicant.hasCriminalRecord() && applicant.getCreditScore() >=500);
