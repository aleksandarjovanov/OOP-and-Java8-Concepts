package FirstMidterm.firstMidtermExam.zad2;
...
class Order implements Comparable<Order>{
    ...
    public String toString() {
        return String.format("%d %d %d %d %d\n", orderId, items.size(), numOfPies(), numOfCakes(), calculateSum());
    }
...
class CakeShopApplication{
    ...
    public void printAllOrders(OutputStream outputStream){
        ...
        orders.stream().sorted(Comparator.reverseOrder()).forEach(pw::print);
        pw.flush();
    }
